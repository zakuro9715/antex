...
var parserATN = []uint16{
	3, 24715, 42794, 33075, 47597, 16764, 15335, 30598, 22884, 3, 3, 7, 4, 
...
// AntexParserRULE_expr is the AntexParser rule.
const AntexParserRULE_expr = 0
...
func (p *AntexParser) Expr() (localctx IExprContext) {
	...
	p.EnterRule(localctx, 0, AntexParserRULE_expr)
